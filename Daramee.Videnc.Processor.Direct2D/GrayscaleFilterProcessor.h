...
namespace Daramee
{
	namespace Videnc
	{
		namespace Processors
		{
			namespace Video
			{
				public ref class GrayscaleFilterProcessor : public Daramee::Videnc::IVideoProcessor
				{
				public:
					GrayscaleFilterProcessor ();
					~GrayscaleFilterProcessor ();

				public:
					// IProcessor을(를) 통해 상속됨
					virtual property System::String ^ ProcessorType { System::String^ get () { return "grayscale"; } }
